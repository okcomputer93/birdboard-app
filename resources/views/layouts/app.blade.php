...
<body class="theme-dark bg-page font-body">
    <div id="app">
        <nav class="bg-header">
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            @else
                                <li class="nav-item dropdown">
                                    <a id="navbarDropdown" class="text-default nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                        {{ Auth::user()->name }}
                                    </a>
